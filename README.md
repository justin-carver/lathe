...
Generate personalized, hands-on technical tutorials on demand via LLM and read them in your browser through a local UI built from the ground up for learning. An experiment to use LLMs for teaching you, instead of thinking for you.
